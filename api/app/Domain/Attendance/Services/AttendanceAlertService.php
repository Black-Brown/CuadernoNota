 ...
 *
 * Regla 1 — Ausencias consecutivas en el curso:
 *   Si un estudiante acumula 3 o más ausencias no justificadas
 *   de forma consecutiva en la materia, se activa la alerta.
...
{
    /** Número de ausencias no justificadas consecutivas que activan la alerta. */
     ...
     * dentro del conjunto de registros de la materia.
     *
     * @param  AttendanceRecord[]  $courseRecords  Registros de la materia para el estudiante.
     ...
     */
    public function hasConsecutiveAbsenceAlert(array $courseRecords): bool
    {
